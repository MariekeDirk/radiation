...
m4.svmRadial<-caret::train(Q ~ SAT + day,
                           data = train,
                           method = "svmRadial",
                           preProcess = c("center","scale","BoxCox"),
                           verbose = FALSE,
...
m5.svmLinear<-caret::train(Q ~ SAT + day,
                           data = train,
                           method = "svmLinear",
                           preProcess = c("center","scale","BoxCox"),
                           verbose = FALSE,
...
#### Tree models
```{r tree models}
m7.cubist <- caret::train(Q ~ SAT + day,
                          data = train,
                          method = "cubist",
                          preProcess = c("center","scale","BoxCox"),
                          verbose = FALSE,
...
m10.earth <- caret::train(Q ~ SAT + day,
                          data = train,
                          method = "earth",
                          preProcess = c("center","scale","BoxCox"),
                          tuneLength = length,
...
m13.nnet <- caret::train(Q ~ SAT + day,
                         data = train,
                         method = "nnet",
                         #metric = "ROC",
