...
daily.statistics<-fread("/nobackup/users/dirksen/radiation/Rdata/Kriging/statistics_daily.txt")
daily.statistics$t<-as.Date(daily.statistics$t)
#20 year output
##################################################
##################################################
r.siccs.20yearmean<-"/nobackup/users/dirksen/radiation/Rdata/Kriging/Climatology/12year_siccs/siccs_12year_mean.grd"
r.siccs.20yearsd<-"/nobackup/users/dirksen/radiation/Rdata/Kriging/Climatology/12year_siccs/siccs_12year_sd.grd"

r.distshore.20yearmean<-"/nobackup/users/dirksen/radiation/Rdata/Kriging/Climatology/12year_mean_distshore/ked_exp_prediction_distsea.grd"
r.distshore.20yearmean.sum<-"/nobackup/users/dirksen/radiation/Rdata/Kriging/Climatology/12year_mean_distshore/ked_exp_pointdifference.txt"


r.distshore.20yearsd<-"/nobackup/users/dirksen/radiation/Rdata/Kriging/Climatology/12year_sd_distshore/ked_exp_prediction_distsea.grd"

r.climatology.20yearmean<-"/nobackup/users/dirksen/radiation/Rdata/Kriging/Climatology/12year_mean/ked_exp_prediction_siccs.grd"
r.climatology.20yearmean.sum<-"/nobackup/users/dirksen/radiation/Rdata/Kriging/Climatology/12year_mean/ked_exp_pointdifference.txt"


r.climatology.20yearsd<-"/nobackup/users/dirksen/radiation/Rdata/Kriging/Climatology/12year_sd/ked_exp_prediction_siccs.grd"
##################################################
##################################################
...
##################################################
##################################################
r.climatology<-list.files("/nobackup/users/dirksen/radiation/Rdata/Kriging/Climatology/Quarters_mean/",pattern=".grd",full.names=T)
climatology.sum<-list.files("/nobackup/users/dirksen/radiation/Rdata/Kriging/Climatology/Quarters_mean/",pattern=".txt",full.names = T)
# climatology.sum<-fread(climatology.sum)


r.climatology.sd<-list.files("/nobackup/users/dirksen/radiation/Rdata/Kriging/Climatology/Quarters_sd/",pattern=".grd",full.names=T)
climatology.sum.sd<-list.files("/nobackup/users/dirksen/radiation/Rdata/Kriging/Climatology/Quarters_sd/",pattern=".txt",full.names = T)
...
r.quarters.satellite.sd<-"/nobackup/users/dirksen/radiation/Rdata/Satellite_data/climatology/quarters_sd.rds"
r.quarters.satellite.sd<-readRDS(r.quarters.satellite.sd)

#Distsea
r.quarters.distsea.mean<-list.files("/nobackup/users/dirksen/radiation/Rdata/Kriging/Climatology/Quarters_mean_distshore/",pattern=".grd",full.names=T)
r.quarters.distsea.sd<-list.files("/nobackup/users/dirksen/radiation/Rdata/Kriging/Climatology/Quarter_sd_distshore/",pattern=".grd",full.names=T)
...
library(mgcv)
data.obs<-fread("/nobackup/users/dirksen/radiation/Rdata/sat_over_obs2.csv")
...
function(input, output) {
  ...
  observeEvent(input$saveclim,{
    ggsave(file="/nobackup/users/dirksen/radiation/Rdata/Kriging/shinyapp_kriging/fig/siccs_clim12year_mean.png",
                       plot=plot.siccs.clim12yr.mean())
    
    ggsave(file="/nobackup/users/dirksen/radiation/Rdata/Kriging/shinyapp_kriging/fig/siccs_clim12year_sd.png"
                       ,plot=plot.siccs.clim12yr.sd())
    
    ggsave(file="/nobackup/users/dirksen/radiation/Rdata/Kriging/shinyapp_kriging/fig/ked_distshore_clim12year_mean.png",
           plot=plot.distsea.clim12yr.m())
    
    ggsave(file="/nobackup/users/dirksen/radiation/Rdata/Kriging/shinyapp_kriging/fig/ked_distshore_clim12year_sd.png"
           ,plot=plot.distsea.clim12yr.sd())
    
    ggsave(file="/nobackup/users/dirksen/radiation/Rdata/Kriging/shinyapp_kriging/fig/ked_siccs_clim12year_mean.png",
           plot=plot.clim.12year.mean())
    
    ggsave(file="/nobackup/users/dirksen/radiation/Rdata/Kriging/shinyapp_kriging/fig/ked_siccs_clim12year_sd.png"
  ...
  observeEvent(input$savemean,{
    ggsave(file=paste0("/nobackup/users/dirksen/radiation/Rdata/Kriging/shinyapp_kriging/fig/seasons_distshore_mean_Q",
                       input$season,".png"),plot=plot.seasons.mean.distshore())
    
    ggsave(file=paste0("/nobackup/users/dirksen/radiation/Rdata/Kriging/shinyapp_kriging/fig/seasons_distshore_sd_Q",
                       input$season,".png"),plot=plot.seasons.sd.distshore())
    
    ggsave(file=paste0("/nobackup/users/dirksen/radiation/Rdata/Kriging/shinyapp_kriging/fig/seasons_mean_Q",
                       input$season,".png"),plot=plot.seasons.mean())
    
    ggsave(file=paste0("/nobackup/users/dirksen/radiation/Rdata/Kriging/shinyapp_kriging/fig/seasons_sd_Q",
                       input$season,".png"),plot=plot.seasons.sd())
    
    ggsave(file=paste0("/nobackup/users/dirksen/radiation/Rdata/Kriging/shinyapp_kriging/fig/seasons_siccs_sd_Q",
  ...
  plot.daily.mean<-reactive({
    function(grid,title){
      ...
      labs(title=title,x="x-coords",y="y-coord")+
      facet_wrap(~ variable) +
      scale_fill_gradientn(name="W/m2",colours=do.call(input$color,list(n=50))) +
      # coord_equal()+
  ...
  observeEvent(input$saveday,{
    ggsave(file=paste0("/nobackup/users/dirksen/radiation/Rdata/Kriging/shinyapp_kriging/fig/kriging_prediction",
                       input$date,".png"),plot=plot.kriging.day())
    
    ggsave(file=paste0("/nobackup/users/dirksen/radiation/Rdata/Kriging/shinyapp_kriging/fig/siccs",
  ...
  plot.timediff<-reactive({
    ggplot(data.obs,aes(IT_DATETIME,DIFF))+
      ...
      labs(x="time [years]",y="difference solar irradiance [W/m2]")+
...
plot.timediff()
  ...
  observeEvent(input$savetimediff,{
    ggsave(file=paste0("/nobackup/users/dirksen/radiation/Rdata/Kriging/shinyapp_kriging/fig/difference_time",
                       ranges3$x[1],"_",ranges3$x[2],".png"),plot=plot.timediff())
    ggsave(file=paste0("/nobackup/users/dirksen/radiation/Rdata/Kriging/shinyapp_kriging/fig/RMSE_time",
                       ranges4$x[1],"_",ranges4$x[2],".png"),plot=plot.statistics())
    # ggsave(file=paste0("/nobackup/users/dirksen/radiation/Rdata/Kriging/shinyapp_kriging/fig/difference_time_",
